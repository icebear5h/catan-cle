...
class ActionType(Enum):
    ...
    # Domestic trades use cle.game_engine.trading.TradeOffer.
    OFFER_TRADE = "OFFER_TRADE"
    ACCEPT_TRADE = "ACCEPT_TRADE"
    REJECT_TRADE = "REJECT_TRADE"
    # COUNTER_OFFER uses TradeOffer.parent_offer_id.
    COUNTER_OFFER = "COUNTER_OFFER"
    # CONFIRM_TRADE uses a TradeCandidate selected only by the turn player.
