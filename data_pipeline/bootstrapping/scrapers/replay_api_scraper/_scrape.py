"""Batch replay downloads from a game index, plus JWT expiry validation."""
...
from data_pipeline.bootstrapping.scrapers.replay_api_scraper._parsing import parse_replay
from data_pipeline.json_coerce import as_dict, as_dict_list, as_float, as_int, as_str
...
async def scrape_replays_from_index(
    ...
    with open(index_file) as f:
        index_payload: JsonValue = json.load(f)
    games = as_dict_list(index_payload)
