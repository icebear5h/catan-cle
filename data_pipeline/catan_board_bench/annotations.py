...
from data_pipeline.catan_board_bench.tokens import atlas_metadata, canonical_edge
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--bench-dir",
        type=Path,
        default=Path("data_pipeline/catan_board_bench/datasets/catan_board_bench_100"),
