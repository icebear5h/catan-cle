...
``GameEngine`` into a public board contract, deterministic question/answer items, and
...
from game_engine.models.board import get_edges
...
from data_pipeline.catan_board_bench.tokens import (
    base_edges,
    building_token,
    canonical_edge,
    color_token,
...
def build_catan_board_bench_sync(**kwargs: Any) -> BenchmarkBuildResult:
