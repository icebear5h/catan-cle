...
from data_pipeline.catanbench.tokens import atlas_metadata, canonical_edge
            ...
            _annotation(
                ...
                semantic={
                    ...
                    "attached_node_tokens": [
                        _object_token("N", node_id)
                        for node_id in tile.get("port_nodes", [])
                    ],
                },
            )
        )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--bench-dir",
        type=Path,
        default=Path("data_pipeline/catanbench/datasets/catanbench_100"),
