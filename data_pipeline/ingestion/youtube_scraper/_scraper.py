"""Fetch Catan strategy video transcripts and metadata from YouTube."""
...
from data_pipeline.ingestion.youtube_scraper._types import (
    ScrapedVideo,
    TranscriptChunk,
    TranscriptSegment,
    VideoMetadata,
...
class YouTubeScraper:
    ...
    def scrape_video(self, video_url: str) -> Optional[ScrapedVideo]:
        """
    ...
    def save_transcript(self, result: ScrapedVideo,
                        output_dir: str = "artifacts/generated/pretraining/legacy_corpus") -> str:
        """
