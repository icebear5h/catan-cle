...
from game_engine.models.decks import freqdeck_count
...
from game_engine.models.board import STATIC_GRAPH, get_edges, get_node_distances
from game_engine.models.map import NUM_TILES, CatanMap, build_map, number_probability
...
# ===== Extractors
def player_features(game: GameEngine, p0_color: Color):
    # P0_ACTUAL_VPS
...
def resource_hand_features(game: GameEngine, p0_color: Color):
...
def tile_features(game: GameEngine, p0_color: Color):
    # Returns list of functions that take a game and output a feature.
    # build features like tile0_is_wood, tile0_is_wheat, ..., tile0_proba, tile0_hasrobber
...
def graph_features(game: GameEngine, p0_color: Color):
...
def build_production_features(consider_robber):
    ...
    def production_features(game: GameEngine, p0_color: Color):
...
def get_player_expandable_nodes(game: GameEngine, color: Color):
...
def reachability_features(game: GameEngine, p0_color: Color, levels=REACHABLE_FEATURES_MAX):
    features = {}
...
def expansion_features(game: GameEngine, p0_color: Color):
...
def port_distance_features(game: GameEngine, p0_color: Color):
...
def game_features(game: GameEngine, p0_color: Color):
