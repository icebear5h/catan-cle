# CatanBoardBench-100 Pre-SFT Investigation
...
- `data_pipeline/catan_board_bench/datasets/catan_board_bench_100/leakage/benchmark_game_ids.md`
- `reports/catan_board_bench/catan_board_bench_100_openrouter_baseline.md`
- `artifacts/runs/catan_board_bench/catan_board_bench_100/openrouter/`

## Leakage Boundary

CatanBoardBench-100 is evaluation-only. The game IDs in
`data_pipeline/catan_board_bench/datasets/catan_board_bench_100/leakage/benchmark_game_ids.md`
...
in `artifacts/raw/colonist/replays` overlaps the held-out benchmark.
Use `artifacts/raw/colonist/indexes/4p_games_training_candidates.json` as the
...
- Gains caused by adding CatanBoardBench images or contracts to training.
...
| Eval split | Must be CatanBoardBench-100 held-out IDs. |
