...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--bench-dir", type=Path, default=Path("data_pipeline/catanbench/datasets/catanbench_100")
    )
    ...
    parser.add_argument(
        "--qa",
        type=Path,
        default=Path("data_pipeline/catanbench/datasets/catanbench_100/questions/qa.jsonl"),
