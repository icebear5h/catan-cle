...
`sft.scripts.build_board_fluency_review` is the authority (two edges join through
...
from sft.scripts.build_board_fluency_review import COMPONENT_RULES, Facts
