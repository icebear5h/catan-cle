...
MODAL_PROFILE=icebear5h CATAN_HF_SECRET_NAME=huggingface-secret-2 \
    .venv/bin/python -B -m sft.launchers.board_fluency.modal_board_fluency_extension2 \
...
from ._baselines import teacher_path_for as teacher_path_for
...
from ._config import COST_R06_KEY as COST_R06_KEY
from ._config import COST_R06_SHA256 as COST_R06_SHA256
...
from ._config import PRIOR_R06_USD as PRIOR_R06_USD
from ._config import PRIOR_USD as PRIOR_USD
from ._config import R01_ADDENDUM_SHA256 as R01_ADDENDUM_SHA256
from ._config import R01_RECORDED_USD as R01_RECORDED_USD
from ._config import R01_SUBTOTAL_KEY as R01_SUBTOTAL_KEY
...
from ._prepare import Extension2Callback as Extension2Callback
