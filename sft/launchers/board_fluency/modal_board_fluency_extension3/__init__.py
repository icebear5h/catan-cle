...
MODAL_PROFILE=icebear5h CATAN_HF_SECRET_NAME=huggingface-secret-2 \
    .venv/bin/python -B -m sft.launchers.board_fluency.modal_board_fluency_extension3 \
...
from ._config import LOCAL_R01 as LOCAL_R01
...
from ._config import PRIOR_R01_USD as PRIOR_R01_USD
from ._config import PRIOR_USD as PRIOR_USD
from ._config import R01_ADDENDUM_SHA256 as R01_ADDENDUM_SHA256
from ._config import R01_CHECKPOINT as R01_CHECKPOINT
from ._config import R01_ROOT as R01_ROOT
from ._config import R01_RUN as R01_RUN
from ._config import R01_TOTAL_KEY as R01_TOTAL_KEY
from ._config import R02_ADDENDUM_SHA256 as R02_ADDENDUM_SHA256
from ._config import R02_PRIOR_KEY as R02_PRIOR_KEY
from ._config import R02_RECORDED_USD as R02_RECORDED_USD
from ._config import R02_SUBTOTAL_KEY as R02_SUBTOTAL_KEY
...
from ._prepare import Extension3Callback as Extension3Callback
from ._prepare import check_schedule_history as check_schedule_history
from ._prepare import check_schedule_log as check_schedule_log
