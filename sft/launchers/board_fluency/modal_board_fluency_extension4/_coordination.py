...
from sft.launchers.board_fluency.modal_board_fluency_extension3._types import dig, recorded_app_id
...
def coordinate_work(plan: JsonDict, absolute_deadline: float, app_id: str) -> JsonDict:
    ...
    try:
        ...
        result.update(status="completed", comparison=comparison, additional_updates=512, cumulative_updates=1536)
