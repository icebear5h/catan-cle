"""Launcher for behavior and forgetting matrices on the Modal runs volume."""
...
from sft.analysis.behavior_diagnostics import history_markdown
from sft.json_types import JsonDict
from sft.scripts.report.report_behavior_history import build_report, parse_checkpoint
...
def report_remote(checkpoints: str, output_dir: str) -> JsonDict:
