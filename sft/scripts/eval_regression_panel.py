...
PANEL = (
    ...
    (REPLAY_ROOT / "spatial_localization_pairs_v1/stage1/validation.jsonl", REPLAY_ROOT / "spatial_localization_pairs_v1/images", "adjacent-pair validation, two touching pieces per image"),
