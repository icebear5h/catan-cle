...
from scripts.board_bench.run.summarize_catan_unified_benchmark import (
    paired_modalities,
    validate_current_model_records,
)


def test_paired_modalities_keeps_image_and_text_panels_separate() -> None:
    image_records: Any = []
    text_records: Any = []
...
def test_old_qwen_checkpoint_is_rejected() -> None:
