...
def test_colonist_victory_points_weights_city_awards_and_hidden_vp() -> None:
...
def test_replay_issue_filtering_by_severity() -> None:
...
def test_final_state_sync_forces_colonist_scoreboard_fields() -> None:
    game = GameEngine(
        [
            Color.RED,
            Color.BLUE,
