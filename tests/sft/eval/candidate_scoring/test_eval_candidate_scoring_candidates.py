"""Candidate sets, ranking, and job batching."""
...
from .support import ATLAS, _Tokenizer


def test_candidate_sets_follow_entity_type_marker_letters_and_polarity() -> None:
...
def test_candidate_ranking_reports_argmax_and_expected_rank() -> None:
...
def test_summary_carries_candidate_accuracy_beside_exact_match() -> None:
...
def test_eval_jobs_keep_single_layout_and_nest_batches(tmp_path: Path) -> None:
