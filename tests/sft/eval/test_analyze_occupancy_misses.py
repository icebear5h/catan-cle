...
from sft.scripts.eval.analyze_occupancy_misses import analyze, main
...
def test_cli_writes_output_and_skips_other_categories(tmp_path: Path, fixture_contract: dict, capsys: pytest.CaptureFixture[str]) -> None:
    records_path, eval_path, contracts_dir = write_inputs(tmp_path, fixture_contract)
