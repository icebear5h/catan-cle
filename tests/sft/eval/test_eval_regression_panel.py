...
from sft.scripts.eval.eval_regression_panel import build_command, selected_panel


def test_regression_panel_supports_named_targeted_backfills() -> None:
...
def test_regression_panel_rejects_unknown_subset() -> None:
