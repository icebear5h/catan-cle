from sft.scripts.eval.check_spatial_grounding_gates import stage1_gates, stage2_gates


def _summary(accuracy: float, **dimensions: object) -> dict[str, object]:
...
def test_stage1_gates_require_visual_gain_and_causal_occlusion_gap() -> None:
    result = stage1_gates(
...
def test_stage2_gates_fail_on_one_weak_relation_bucket() -> None:
    result = stage2_gates(
