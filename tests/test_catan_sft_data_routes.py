...
def test_sft_data_route_exposes_active_bidirectional_training_projection():
...
def test_sft_data_route_filters_inverse_grounding_rows_and_serves_images():
    client = _client()
    response = client.get(
        "/api/catan-board-bench/sft-data",
        query_string={
...
def test_sft_data_route_rejects_unknown_split():
    response = _client().get(
        "/api/catan-board-bench/sft-data",
...
def test_spatial_localization_route_exposes_stage1_patch_targets():
    client = _client()
    response = client.get(
...
def test_spatial_localization_route_filters_stage2_hard_negatives():
    response = _client().get(
        "/api/catan-board-bench/spatial-localization-data",
        query_string={
            "stage": "stage2",
...
def test_spatial_localization_probes_do_not_accept_train_split():
    response = _client().get(
        "/api/catan-board-bench/spatial-localization-data",
...
def test_sft_eval_route_filters_exact_failures():
    response = _client().get(
        "/api/catan-board-bench/sft-eval",
        query_string={
...
def test_sft_eval_route_rejects_unknown_correctness_filter():
    response = _client().get(
        "/api/catan-board-bench/sft-eval",
