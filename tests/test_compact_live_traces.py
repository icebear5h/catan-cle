...
def test_compact_packs_legacy_rows_once_and_preserves_every_reader(tmp_path):
...
def test_compact_cli_reports_then_applies_and_vacuums(tmp_path, capsys):
