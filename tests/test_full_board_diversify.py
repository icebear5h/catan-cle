...
from data_pipeline.board_recognition.full_board_diversify import QUOTAS, placement_hash, select_positions
from data_pipeline.board_recognition.replay_dataset import generate_engine_trajectory_candidates


def test_new_layout_selection_is_legal_distinct_and_density_balanced():
