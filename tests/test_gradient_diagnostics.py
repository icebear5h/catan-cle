...
def test_probe_selection_is_deterministic_stratified_and_training_only():
...
def test_gradient_relationship_reports_raw_and_lr_scaled_all_group():
    learning_rates = {
        "vision": 1.0,
        "merger": 2.0,
        "language_lora": 3.0,
...
def test_gradient_report_contains_behavior_norms_and_minibatch_stability():
    runs = {}
...
def test_gradient_trajectory_rejects_different_probe_selections():
    minimal = {
