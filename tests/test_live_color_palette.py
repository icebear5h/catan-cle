...
def test_seeded_random_palette_is_distinct_deterministic_and_rng_isolated():
...
def test_canonical_palette_and_balanced_datagen_cover_all_colors():
...
def test_snapshot_restore_uses_exact_realized_colors():
...
def test_llm_vs_random_owns_first_realized_color_when_red_is_absent():
    seed = next(
        candidate
