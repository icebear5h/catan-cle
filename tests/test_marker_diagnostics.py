...
from sft.marker_diagnostics import analyze, select_rows, selection_manifest
...
def test_selection_is_deterministic_and_paired():
    rows = source_rows()
...
def test_duplicates_and_missing_pairs_rejected():
    rows = source_rows()
...
def test_miss_modes_and_orientation():
    rows = source_rows()
    selected = select_rows(rows)
...
def test_partial_records_and_bad_ids():
    rows = source_rows()
    selected = select_rows(rows)
...
def test_wrong_location_and_answer_type():
    rows = source_rows()
    selected = select_rows(rows)
...
def test_mismatched_pair_images_rejected():
    rows = source_rows()
...
def test_invalid_location_responses(response, mode):
    rows = source_rows()
    selected = select_rows(rows)
